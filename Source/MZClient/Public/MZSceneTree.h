...
struct MZCLIENT_API  ActorNode : TreeNode
{
...
struct MZCLIENT_API  SceneComponentNode : TreeNode
{
...
struct MZCLIENT_API  FolderNode : TreeNode
{
...
class MZCLIENT_API MZSceneTree {
